...
/**
 * This is the item provider adapter for a {@link com.fukuda.kyudai.system.sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class sensorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_sensor_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_sensor_name_feature", "_UI_sensor_type"),
						SystemPackage.Literals.SENSOR__NAME, true, false, false,
	...
	protected void addProcessPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_sensor_process_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_sensor_process_feature",
								"_UI_sensor_type"),
						SystemPackage.Literals.SENSOR__PROCESS, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case SystemPackage.SENSOR__NAME:
